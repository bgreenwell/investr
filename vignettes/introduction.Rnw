...
\end{example*}
%The interested reader can easily view the package source code at the \href{https://github.com/bgreenwell/investr}{GitHub development site} described earlier.
