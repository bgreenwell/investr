...
![](reference/figures/README-glm-beetle-invest-1.png)
...
`glm`. For instance, the example from
[`?MASS::dose.p`](https://rdrr.io/pkg/MASS/man/dose.p.html) can be
...
![](reference/figures/README-nls-nasturtium-fit-1.png)
...
![](reference/figures/README-nls-nasturtium-bootstrap-1.png)
